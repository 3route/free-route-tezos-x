// scripts/shared/env.ts — load .env into process.env (Node's built-in parser: strips quotes/comments/CRLF;
...
try {
  process.loadEnvFile(new URL('../../.env', import.meta.url)); // repo root, two levels up from scripts/shared/
} catch {
