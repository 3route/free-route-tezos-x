...
import { buildCallMichelsonTransaction } from '../evm/operations/call-michelson.js';
 ...
 *  on the EVM account's Michelson alias). Mirror of `buildMichelsonFulfillAskOperation` for native EVM accounts. */
export const buildEvmFulfillAskTransaction = (p: Omit<FulfillAskOptions, 'limits'> & { evmGateway?: EvmAddress }): EvmTxRequest =>
